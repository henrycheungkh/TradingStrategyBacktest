...
RawDataFilepath = InputFolder + r'prices_' + ticker + '_10 secs_20230601_20240630_0700-1600.zip'
...
backtest_obj = AdhocBacktestKeyLevel(RawDataFilepath, KeyLevelName, KeyLevelFilepath, ticker, ParameterList = ParameterList, DebugExportFilepath=DebugExportFilepath, EconIndicatorFilepath=EconIndicatorFilepath, EconIndicatorParameters = EconIndicatorParameters, ResultOnDayOfWeek = ['Monday', 'Friday'])
