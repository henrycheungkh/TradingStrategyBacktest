...
$sql = "SELECT *, (CurrentPrice - PriorDayClose)/PriorDayClose AS GapSize, Today_Vol/(30MA_Vol+0.001) AS RelativeVol FROM fdata_us_gapper_list WHERE CaptureDate = '" . $date->format('Y-m-d') . "' ORDER BY ABS((CurrentPrice - PriorDayClose)/PriorDayClose) DESC";
