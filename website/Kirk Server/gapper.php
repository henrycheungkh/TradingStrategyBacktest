...
<body>
Gapper<BR><BR>
Price Gap > 4%, Dollar Volume > $50,000<BR><BR>
...
$sql = "SELECT *, (CurrentPrice - PriorDayClose)/PriorDayClose AS GapSize, Today_Vol/(30MA_Vol+0.001) AS RelativeVol FROM finance_fdata_us_gapper_list WHERE CaptureDate = '" . $date->format('Y-m-d') . "' ORDER BY ABS((CurrentPrice - PriorDayClose)/PriorDayClose) DESC";
