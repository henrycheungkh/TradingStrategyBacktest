...
rem "%TradeAnalysis_PythonPath%" "%TradeAnalysis_ProjectPath%InvestmentAnalytics\Batch\Download_Price.py" FXOnly 7000 dayend 3 DirectUpload
rem "%TradeAnalysis_PythonPath%" "%TradeAnalysis_ProjectPath%InvestmentAnalytics\Batch\Download_Price.py" HKOnly 200 dayend 3 DirectUpload
...
rem "%TradeAnalysis_PythonPath%" "%TradeAnalysis_ProjectPath%InvestmentAnalytics\Batch\Download_Price.py" USOnly 1000 dayend 3 DirectUpload
