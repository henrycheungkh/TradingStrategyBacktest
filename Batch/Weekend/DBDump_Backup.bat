...
if %TradeAnalysis_DBPassword%==None ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root finance_fdata_price_1min > "%TradeAnalysis_DBDumpPath%DBDump_fdata_price_1min_%mydate%.sql") else ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root -p%TradeAnalysis_DBPassword% finance_fdata_price_1min > "%TradeAnalysis_DBDumpPath%DBDump_fdata_price_1min_%mydate%.sql")
...
if %TradeAnalysis_DBPassword%==None ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root finance_fdata_fut_hist_10secs > "%TradeAnalysis_DBDumpPath%DBDump_fdata_fut_hist_10secs_%mydate%.sql") else ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root -p%TradeAnalysis_DBPassword% finance_fdata_fut_hist_10secs > "%TradeAnalysis_DBDumpPath%DBDump_fdata_fut_hist_10secs_%mydate%.sql")

if %TradeAnalysis_DBPassword%==None ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root finance_fdata_fut_hist_5secs > "%TradeAnalysis_DBDumpPath%DBDump_fdata_fut_hist_5secs_%mydate%.sql") else ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root -p%TradeAnalysis_DBPassword% finance_fdata_fut_hist_5secs > "%TradeAnalysis_DBDumpPath%DBDump_fdata_fut_hist_5secs_%mydate%.sql")
...
if %TradeAnalysis_DBPassword%==None ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root finance_fdata_price_1min_ib > "%TradeAnalysis_DBDumpPath%DBDump_fdata_price_1min_ib_%mydate%_ib.sql") else ("%TradeAnalysis_mysqldump%" --skip-add-drop-table --no-create-info -u root -p%TradeAnalysis_DBPassword% finance_fdata_price_1min_ib > "%TradeAnalysis_DBDumpPath%DBDump_fdata_price_1min_ib_%mydate%_ib.sql")
