...
rem %TradeAnalysis_mysql% -u %TradeAnalysis_DBUser% finance_frec_fut_hist < %TradeAnalysis_DBDumpPath%DBDump_fdata_fut_hist_20211011.sql
...
rem %TradeAnalysis_mysql% -u %TradeAnalysis_DBUser% finance_fdata_price_1min_ib_2023_q1 < %TradeAnalysis_DBDumpPath%DBDump_fdata_price_1min_ib_20230402_ib.sql
rem %TradeAnalysis_mysql% -u %TradeAnalysis_DBUser% finance_fdata_price_1min_ib_2023_h1 < %TradeAnalysis_DBDumpPath%DBDump_fdata_price_1min_ib_2023_q1.sql
%TradeAnalysis_mysql% -u %TradeAnalysis_DBUser% finance_fdata_fut_hist < %TradeAnalysis_DBDumpPath%DBDump_fdata_fut_hist_20230707.sql
pause