...
//    __global__ void test_cuda_utilisation(int InitialResultCacheSize, int RESULT_COLUMN_COUNT, float *number_matrix, int *result_count, int *real_result_count)
  {
     ...
     for (int i=0; i<331957; i++) {
       ...
       if (result_index < InitialResultCacheSize && result_index >= 0 && result_index_offset >= 0) {
...
print('result_count_out[0] = ' + str(result_count_out[0]) + ' and InitialResultCacheSize = ' + str(InitialResultCacheSize) + ' and real_result_count_out[0] = ' + str(real_result_count_out[0]))
