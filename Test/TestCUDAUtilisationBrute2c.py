...
mod = SourceModule("""
  ...
  __global__ void correlation_on_specific_time_section_analysis(int StartTimeInStdUnit, int EndTimeInStdUnit, int TimeIntervalInStdUnit, int obs_movement_threshold_count, float obs_movement_range, float stop_loss, float take_profit, int obs_date_id_offset, int trade_entry_date_id_offset, int ErrorCode, int InitialResultCacheSize, int TRADE_RESULT_COLUMN_COUNT, int *trade_result_count, float *close_data, float *date_id_data, float *time_std_unit_data, float *obs_movement_threshold, float *trade_result)
  {
...
func(np.int32(0), np.int32(0), np.int32(0), np.int32(0), np.float32(0), np.float32(0), np.float32(0), np.int32(0), np.int32(0), np.int32(0), np.int32(0), np.int32(0), trade_result_count_gpu, close_price_matrix_gpu, date_id_matrix_gpu, time_std_unit_matrix_gpu, ObsPeriodMovementThreshold_matrix_gpu, trade_result_gpu, block=(4,16,16))
