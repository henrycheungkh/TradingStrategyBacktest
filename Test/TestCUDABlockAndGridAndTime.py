...
mod = SourceModule("""
  #include <cstdlib>
    ...
    __global__ void test_cuda_utilisation(int LoopCount, int RESULT_COLUMN_COUNT, float *number_matrix, int *result_count)
  {
     int result_index, result_index_offset, thread_Index, j;
     ...
     number_matrix[result_index_offset + 5] = j;
  }
  """)
...
# func(np.int32(1000000), np.int32(RESULT_COLUMN_COUNT), number_matrix_gpu, result_count_gpu, block=(1024,1,1), grid=(8,1))
# start at time 2023-03-19 14:57:41.714956
# end at time 2023-03-19 14:57:45.307019
# func(np.int32(1000000), np.int32(RESULT_COLUMN_COUNT), number_matrix_gpu, result_count_gpu, block=(16,8,8), grid=(8,1))
# start at time 2023-03-19 15:01:02.166716
# end at time 2023-03-19 15:01:03.796244
# func(np.int32(100000000), np.int32(RESULT_COLUMN_COUNT), number_matrix_gpu, result_count_gpu, block=(16,8,8), grid=(8,1))
# start at time 2023-03-19 15:01:44.080478
# end at time 2023-03-19 15:01:46.005488
func(np.int32(100000000), np.int32(RESULT_COLUMN_COUNT), number_matrix_gpu, result_count_gpu, block=(1024,1,1), grid=(8,1))
# start at time 2023-03-19 15:02:26.650277
# end at time 2023-03-19 15:02:28.493288
...
print('end at time ' + str(datetime.now()))
