...
mod = SourceModule("""
  ...
  __global__ void correlation_on_specific_time_section_analysis(int *trade_result_count, float *close_data, float *date_id_data, float *time_std_unit_data, float *obs_movement_threshold, float *trade_result)
  {
...
//    for (int i=0; i<3000000; i++) {
      ...
      trade_result_index_offset = trade_result_index * 4;
...
func(trade_result_count_gpu, close_price_matrix_gpu, date_id_matrix_gpu, time_std_unit_matrix_gpu, ObsPeriodMovementThreshold_matrix_gpu, trade_result_gpu, block=(4,16,16))
