...
def _download_one_threaded(ticker, start=None, end=None,
    ...
    try:
        ...
        shared._DFS[ticker.upper()] = data
        # if ticker.upper() in ["ACBAU", "ACQRW","OSN", "BPY"]:
        #     print(ticker.upper() + ' data is')
        #     print(data)

    except Exception:
        # shared._DFS[ticker.upper()] = None
        # if ticker.upper() in ["ACBAU", "ACQRW","OSN", "BPY"]:
        #     print(ticker.upper() + ' data is')
        #     print(data)
        data = _pd.DataFrame(columns=['Open', 'High', 'Low', 'Close', 'Adj Close', 'Volume'])
        shared._DFS[ticker.upper()] = data
        print('Blank data for ' + ticker.upper() + ' added')
