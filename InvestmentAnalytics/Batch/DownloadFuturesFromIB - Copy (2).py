...
def DownloadFuturesFromIB(BarSize, HistoricalPeriod):
    ...
    for lastTradeDateOrContractMonth in lastTradeDateOrContractMonths:
        ...
        #                 "HE":[{"secType":"FUT", "exchange":"CME", "currency":"USD", "lastTradeDateOrContractMonth":lastTradeDateOrContractMonth}, {"LocalTimeZone":Config.CONFIG_LOCAL_TIMEZONE, "MarketTimeZone":'America/New_York'}],
        ...
        #                 "ZR":[{"secType":"FUT", "exchange":"CBOT", "currency":"USD", "lastTradeDateOrContractMonth":lastTradeDateOrContractMonth}, {"LocalTimeZone":Config.CONFIG_LOCAL_TIMEZONE, "MarketTimeZone":'America/New_York'}],
        #                 "ZL":[{"secType":"FUT", "exchange":"CBOT", "currency":"USD", "lastTradeDateOrContractMonth":lastTradeDateOrContractMonth}, {"LocalTimeZone":Config.CONFIG_LOCAL_TIMEZONE, "MarketTimeZone":'America/New_York'}],
        ...
        #                 "KC":[{"secType":"FUT", "exchange":"NYBOT", "currency":"USD", "lastTradeDateOrContractMonth":lastTradeDateOrContractMonth}, {"LocalTimeZone":Config.CONFIG_LOCAL_TIMEZONE, "MarketTimeZone":'America/New_York'}],
        ...
        #                 # "VIX":[{"secType":"FUT", "exchange":"CFE", "currency":"USD", "lastTradeDateOrContractMonth":lastTradeDateOrContractMonth}, {"LocalTimeZone":Config.CONFIG_LOCAL_TIMEZONE, "MarketTimeZone":'America/New_York'}],
        #                 # "DX":[{"secType":"FUT", "exchange":"NYBOT", "currency":"USD", "lastTradeDateOrContractMonth":lastTradeDateOrContractMonth}, {"LocalTimeZone":Config.CONFIG_LOCAL_TIMEZONE, "MarketTimeZone":'America/New_York'}],
        #                 "2YY":[{"secType":"FUT", "exchange":"CBOT", "currency":"USD", "lastTradeDateOrContractMonth":lastTradeDateOrContractMonth}, {"LocalTimeZone":Config.CONFIG_LOCAL_TIMEZONE, "MarketTimeZone":'America/New_York'}],
