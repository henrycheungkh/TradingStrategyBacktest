...
class FuturesPriceReader(SpotPriceReader):
    DefaultMarketTimeSection = {'1 min':[8*60+30, 9*60+30, 11*60, 15*60, 16*60], '10 secs':[(8*60+30)*6, (9*60+30)*6, (11*60)*6, (15*60)*6, (16*60)*6]}
...
class IBFuturesPriceReader(FuturesPriceReader):
    def GetDataframeFromDB(self, TickerFilter = []):
        DATABASE_FUT_HIST_10SECS_SUFFIX = {2021:"_2021", 2022:"_2022", 2023:""}
