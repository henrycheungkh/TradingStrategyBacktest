...
def CUDAIndicatorSMA(close_price_matrix, MA_Day_List, block_cutting_dimension = "Time Dimension"):
  ...
  """)
    ...
    func(np.int32(block_cutting_by_time), np.int32(first_dimension_size), np.int32(second_dimension_size), np.int32(GPU_CORE_BLOCK_SIZE), np.int32(gpu_core_block_count), close_price_matrix_gpu, indicator_matrix_gpu, MA_Day_matrix_gpu, np.int32(MA_Day_size), block=(1,GPU_CORE_BLOCK_SIZE,1))
