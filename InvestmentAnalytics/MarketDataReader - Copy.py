...
def getAnalysisContext(StartDate, EndDate, TimeFrame, PreFilterDataByTime, PreFilterDataStartTimeInStdUnit, PreFilterDataEndTimeInStdUnit, TickerFilter, KeepDataframeData, PerformContangoAdjustment, RandomNoiseTickerStdev, FillEveryTimeSlot, KeepOnlyWeekdays, DataTimeLowerBound = None, DataTimeUpperBound = None, InstrumentType = 'Futures', MarketTimeSectionTimeList = None, DebugFilepath = None):
