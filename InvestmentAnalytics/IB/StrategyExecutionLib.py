...
from InvestmentAnalytics.IB.IBApiProcessStrategyExecution import *
...
#     process = IBapiStrategyExecution(Tickers, BeginDateOf30Days)
#     ProcessReturnList = RunIBApiProcessHub([process])    
...
def InitiateAndGetIBApiProcess(RequestID_Range = None):
    # if isStartWebSynchronisation:
    #     StartWebSynchronisation()
    # Tickers, BeginDateOf30Days = GetScanGapperParameter("XUSA", StockFilter)
    return IBapiStrategyExecution(RequestID_Range = RequestID_Range)
